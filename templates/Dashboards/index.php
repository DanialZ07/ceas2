...
<div class="card">
    <div class="card-body">
        <h3 class="card-title"><?= __('Welcome to the UiTM Credit Exemption System') ?></h3>
        <p class="card-text">
            <?= __('The UiTM Credit Exemption System is designed to streamline the process of applying for credit exemptions. This system enables students to submit their exemption requests online, track their application status, and receive updates in real time. By replacing traditional paper-based workflows, the system simplifies the process for both students and administrators.') ?>
        </p>
        <p class="card-text">
            <?= __('Here’s what you can do:') ?>
        </p>
        <ul>
            <li><?= __('Submit and manage your credit exemption applications.') ?></li>
            <li><?= __('Track the status of your applications in real time.') ?></li>
            <li><?= __('Receive notifications about approvals or rejections.') ?></li>
            <li><?= __('Access helpful FAQs and contact support if needed.') ?></li>
        </ul>
        <p class="card-text">
            <?= __('UiTM is committed to providing a transparent and efficient system for handling credit exemptions. Explore the features of this platform and simplify your academic journey.') ?>
        </p>
    </div>
</div>
