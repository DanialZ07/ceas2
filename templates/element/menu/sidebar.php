    ...
    <div class="px-0">
        <ul class="list-unstyled components">
            ...
            <?php if ($this->Identity->isLoggedIn()) { ?>
                ...
                <li class="menu-item <?= $c_name == 'Exemptions' && $a_name == 'index' ? 'active' : '' ?>">
                    <?= $this->Html->link(__('<i class="menu-icon fa-solid fa-file-pen"></i> Exemptions'), ['controller' => 'Exemptions', 'action' => 'index', 'prefix' => false, $this->Identity->get('slug')], ['class' => 'menu-link', 'escape' => false]) ?>
                </li>
                ...
                <?php if ($this->Identity->isLoggedIn() && $this->Identity->get('user_group_id') == '1') { ?>
                    ...
                    <li class="menu-item <?= $c_name == 'Exemptions' && $a_name == 'index' ? 'active' : '' ?>">
                        <?= $this->Html->link(__('<i class="menu-icon fa-solid fa-file-pen"></i> Exemptions'), ['prefix' => 'Admin', 'controller' => 'Exemptions', 'action' => 'index'], ['class' => 'menu-link', 'escape' => false]) ?>
                    </li>

                    <li class="menu-item <?= $c_name == 'Campuses' && $a_name == 'index' ? 'active' : '' ?>">
                        <?= $this->Html->link(__('<i class="menu-icon fa-solid fa-building-columns"></i> Campuses'), ['prefix' => 'Admin', 'controller' => 'Campuses', 'action' => 'index'], ['class' => 'menu-link', 'escape' => false]) ?>
                    </li>

                    <li class="menu-item <?= $c_name == 'Faculties' && $a_name == 'index' ? 'active' : '' ?>">
                        <?= $this->Html->link(__('<i class="menu-icon fa-solid fa-building"></i> Faculties'), ['prefix' => 'Admin', 'controller' => 'Faculties', 'action' => 'index'], ['class' => 'menu-link', 'escape' => false]) ?>
                    </li>

                    <li class="menu-item <?= $c_name == 'Programs' && $a_name == 'index' ? 'active' : '' ?>">
                        <?= $this->Html->link(__('<i class="menu-icon fa-solid fa-user-graduate"></i> Programs'), ['prefix' => 'Admin', 'controller' => 'Programs', 'action' => 'index'], ['class' => 'menu-link', 'escape' => false]) ?>
                    </li>

                    <li class="menu-item <?= $c_name == 'Semesters' && $a_name == 'index' ? 'active' : '' ?>">
                        <?= $this->Html->link(__('<i class="menu-icon fa-solid fa-list-ol"></i> Semesters'), ['prefix' => 'Admin', 'controller' => 'Semesters', 'action' => 'index'], ['class' => 'menu-link', 'escape' => false]) ?>
                    </li>
