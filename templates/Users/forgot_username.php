    ...
    <div class="card bg-body-tertiary border-0 shadow-lg mb-4 rounded-lg">
        <div class="card-body p-4">
            ...
            <div class="text-center mb-4">
                <h1 class="display-5 fw-bold text-primary-light"><?php echo $title; ?></h1>
                <p class="text-muted"><?php echo $system_name; ?></p>
            </div>
            ...
            <div class="text-center mt-4">
                ...
                <span class="mx-2 text-muted">|</span>
                <a href="<?= $this->Url->build(['controller' => 'Users', 'action' => 'forgot_password']); ?>" class="link-primary">Forgot Password</a>
            </div>
